                 ...
                 <div class="card border-info">
                     ...
                     <div class="card-body">
                         ...
                         <form action="" method="post">
                             ...
                             <input type="hidden" name="harga" id="harga" class="form-control border-info" value="<?= $penumpang['harga'] = 280000; ?>">
                             <input type="hidden" name="jurusan" id="jurusan" class="form-control border-info" value="<?= $penumpang['jurusan'] = 'Poncol'; ?>">
                             <input type="hidden" name="kelas" id="kelas" class="form-control border-info" value="<?= $penumpang['kelas'] = 'Bisnis'; ?>">
