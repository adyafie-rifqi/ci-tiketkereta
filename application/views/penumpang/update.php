                        ...
                        <div class="row no-gutters align-item-center">
                            <div class="col mr-2">
                                ...
                                <div class="text-md text-gray-800">
                                    <a href="<?= base_url('penumpang/executive'); ?>" class="text-md text-gray-800 btn btn-outline-info">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-item-center">
                            <div class="col mr-2">
                                ...
                                <div class="text-md text-gray-800">
                                    <a href="<?= base_url('penumpang/bisnis'); ?>" class="text-md text-gray-800 btn btn-outline-success">
                                        <i class="fas fa-hand-point-right"></i> Lihat</a>
                                </div>
                            </div>
                            <div class="col-auto">
